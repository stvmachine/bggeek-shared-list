...
export type GetUserCollectionQuery = { __typename?: 'Query', userCollection?: { __typename?: 'Collection', totalItems: number, pubDate: string, items: Array<{ __typename?: 'CollectionItem', objectId: string, name: string, thumbnail: string, image: string, yearPublished: number, numPlays: number, status: { __typename?: 'Status', own: string, prevOwned: string, forTrade: string, want: string, wantToPlay: string, wantToBuy: string, wishlist: string, preordered: string, lastModified: string } }> } | null };
...
export type GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, username: string, firstName: string, lastName: string, dateRegistered: string, supportYears: number, designerId?: string | null, publisherId?: string | null, address?: { __typename?: 'Address', city: string, isoCountry: string } | null, guilds: Array<{ __typename?: 'Guild', id: string, name: string }>, microbadges: Array<{ __typename?: 'Microbadge', id: string, name: string, imageSrc: string }>, top: Array<{ __typename?: 'TopItem', boardgame: { __typename?: 'BoardgameRank', rank: number, id: string, type: string, name: string } }> } | null };
...
export type SearchGamesQuery = { __typename?: 'Query', search: Array<{ __typename?: 'Thing', id: string, name: string, type: ThingType }> };
...
export type GetGameDetailsQuery = { __typename?: 'Query', thing?: { __typename?: 'Thing', id: string, name: string, type: ThingType, yearPublished?: number | null, image?: string | null, thumbnail?: string | null } | null };
 ...
 * });
 */
export function useGetUserCollectionQuery(baseOptions: Apollo.QueryHookOptions<GetUserCollectionQuery, GetUserCollectionQueryVariables> & ({ variables: GetUserCollectionQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserCollectionQuery, GetUserCollectionQueryVariables>(GetUserCollectionDocument, options);
      }
export function useGetUserCollectionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserCollectionQuery, GetUserCollectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserCollectionQuery, GetUserCollectionQueryVariables>(GetUserCollectionDocument, options);
        }
export function useGetUserCollectionSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetUserCollectionQuery, GetUserCollectionQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetUserCollectionQuery, GetUserCollectionQueryVariables>(GetUserCollectionDocument, options);
        }
